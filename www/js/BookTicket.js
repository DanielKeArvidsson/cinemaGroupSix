class BookTicket extends Component {
    ...
    bookTickets() {
      ...
      for (let seat of this.bookTickets) {
        seat.baseEl.removeClass('choosen-program');
      }
      
      this.bookTickets = this.highlightedSeats;
      for (let seat of this.bookTickets) {
        seat.baseEl.addClass('book-tickets').removeClass('highlighted-seat');
      }
    }
    ...
    async sendBookingRequest() {
      const booking = new Booking({
        ...
        seats: this.bookTickets.map(seat => seat.seatNumber),
