...
const items = [
  {
    src: ColdWar,
    altText: '',
    caption: 'Cold War, Det underförståddas konst som bara en riktig mästare behärskar.',
  ...
  },
  {
    src: ShopLifters,
    altText: '',
    caption: 'Shoplifters, Nytt mästerverk av vår tids främsta familjeskildrare.',
  }
];
    ...
    const slides = items.map((item) => {
      return (
        ...
        >
          ...
          <CarouselCaption className="captionHeader"captionHeader={item.caption} />
        </CarouselItem>
      );
    });
