    ...
    render() { 
        return ( 
            <section className="book-ticket">
                <div className="">
                    ...
                    <div className="row mt-4 mb-4">
                        ...
                        <div className="ticket-incrementor adult">
                            <button className="decrement-adult btn btn-secondary mr-2" onClick={this.decrementAdult}>-</button>{this.adult}<button className="increment-adult btn btn-secondary ml-2">+</button>
                        </div>
                        </div>
                        ...
                        <div className="ticket-incrementor senior">
                            <button className="decrement-senior btn btn-secondary mr-2">-</button>{this.senior}<button className="increment-senior btn btn-secondary ml-2">+</button>
                        </div>
                        </div>
                        ...
                        <div className="ticket-incrementor kids">
                            <button className="decrement-kid btn btn-secondary mr-2">-</button>{this.kid}<button className="increment-kid btn btn-secondary ml-2">+</button>
                        </div>
                        </div>
                    </div>
                ...
                <div className="row">
                        <button type="button" className=" col-md-2 btn btn-secondary booked-tickets p-2 m-4 mt-5 mb-4">
                        Boka biljetter
                        </button>
                </div>
                </div>
